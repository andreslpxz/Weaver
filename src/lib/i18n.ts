...
const dict: Record<Lang, Dict> = {
  es: {
    ...
    'sidebar.pin': 'Fijar chat',
    'sidebar.unpin': 'Quitar fijado',
    ...
    // Modo IDE
    'ide.title': 'Weaver · IDE',
    'ide.folder': 'Carpeta',
    'ide.normal': 'Normal',
    'ide.explorer': 'Explorador',
    'ide.hideExplorer': 'Ocultar explorador',
    'ide.openFileFromExplorer': 'Abre un archivo desde el explorador',
    'ide.chooseWorkingFolder': 'Elegir carpeta de trabajo',
    'ide.changes': 'Cambios',
    'ide.terminal': 'Terminal',
    'ide.clear': 'Limpiar',
    'ide.hideBottomPanel': 'Ocultar panel inferior',
    'ide.agent': 'Agente',
    'ide.hideAgent': 'Ocultar agente',
    'ide.browserNoTauri': 'Modo navegador: las operaciones de archivos requieren Tauri',
    'ide.changesWillShowHere': 'Cuando el agente modifique archivos, verás aquí los cambios.',
    'ide.created': 'Creado',
    'ide.modified': 'Modificado',
    'ide.deleted': 'Eliminado',
    'ide.now': 'ahora',
    'ide.minAgo': 'hace {n} min',
    'ide.hourAgo': 'hace {n} h',
    'ide.lines': 'líneas',
    'ide.agentChanges': 'cambios del agente',
    'ide.unsaved': '● Sin guardar',
    'ide.save': 'Guardar',
    'ide.loadingFile': 'Cargando…',
    'ide.couldNotLoad': 'No se pudo cargar el archivo',
    'ide.terminalHint': 'Escribe un comando y pulsa Enter. Usa help para ver los built-ins.',
    'ide.noWorkingFolder': 'Sin carpeta de trabajo',
    'ide.chooseFolder': 'Elegir carpeta',
    'ide.openFolder': 'Abrir carpeta',

    // Composer
    'composer.placeholder.empty': 'Dime lo que quieres hacer… (usa @ para mencionar skills, proyectos, proveedores)',
    'composer.placeholder.attachments': 'Añade contexto o instrucciones sobre los archivos…',
    'composer.add': 'Añadir (archivo, carpeta, URL, modos…)',
    'composer.addPhotos': 'Agregar fotos y archivos',
    'composer.addPhotosDesc': 'Texto, imagen o binario',
    'composer.uploadFolder': 'Subir carpeta',
    'composer.uploadFolderDesc': 'Todos los archivos recursivamente',
    'composer.addFromUrl': 'Añadir desde URL',
    'composer.addFromUrlDesc': 'Descarga y adjunta',
    'composer.attachApp': 'Adjuntar app',
    'composer.attachAppDesc': 'Conectar vía AT-SPI',
    'composer.attachAppTauriRequired': 'Requiere Tauri',
    'composer.modePlan': 'Modo plan',
    'composer.modePlanDesc': 'Proponer plan y esperar confirmación',
    'composer.pursueObjective': 'Perseguir objetivo',
    'composer.pursueObjectiveDesc': 'Iterar hasta completar (3 intentos)',
    'composer.addons': 'Complementos',
    'composer.addonsDesc': 'Skills y servidores MCP',
    'composer.voice': 'Voz',
    'composer.send': 'Enviar (Enter)',
    'composer.stop': 'Detener',
    'composer.changeModel': 'Cambiar modelo',
    'composer.urlPrompt': 'URL del archivo a descargar:',
    'composer.attachedApp': 'App adjunta',
    'composer.detachApp': 'Quitar app adjunta',
    'composer.attachAppRequiresTauri': 'Adjuntar app requiere modo Tauri. Ejecuta con npm run tauri:dev.',
    'composer.nAttachments': '{n} adjunto(s) · arrastrar más o pulsar + para añadir',
    'composer.disclaimer': 'Weaver puede equivocarse. Verifica acciones críticas.',
  },
  ...
  en: {
    ...
    'ide.hideExplorer': 'Hide explorer',
    'ide.openFileFromExplorer': 'Open a file from the explorer',
    'ide.chooseWorkingFolder': 'Choose working folder',
    'ide.changes': 'Changes',
    'ide.terminal': 'Terminal',
    'ide.clear': 'Clear',
    'ide.hideBottomPanel': 'Hide bottom panel',
    'ide.agent': 'Agent',
    'ide.hideAgent': 'Hide agent',
    'ide.browserNoTauri': 'Browser mode: file operations require Tauri',
    'ide.changesWillShowHere': 'When the agent modifies files, you will see changes here.',
    'ide.created': 'Created',
    'ide.modified': 'Modified',
    'ide.deleted': 'Deleted',
    'ide.now': 'now',
    'ide.minAgo': '{n} min ago',
    'ide.hourAgo': '{n} h ago',
    'ide.lines': 'lines',
    'ide.agentChanges': 'agent changes',
    'ide.unsaved': '● Unsaved',
    'ide.save': 'Save',
    'ide.loadingFile': 'Loading…',
    'ide.couldNotLoad': 'Could not load file',
    'ide.terminalHint': 'Type a command and press Enter. Use help for built-ins.',
    'ide.noWorkingFolder': 'No working folder',
    'ide.chooseFolder': 'Choose folder',
    'ide.openFolder': 'Open folder',

    // Composer
    'composer.placeholder.empty': 'Tell me what you want to do… (use @ to mention skills, projects, providers)',
    'composer.placeholder.attachments': 'Add context or instructions about the files…',
    'composer.add': 'Add (file, folder, URL, modes…)',
    'composer.addPhotos': 'Add photos and files',
    'composer.addPhotosDesc': 'Text, image, or binary',
    'composer.uploadFolder': 'Upload folder',
    'composer.uploadFolderDesc': 'All files recursively',
    'composer.addFromUrl': 'Add from URL',
    'composer.addFromUrlDesc': 'Download and attach',
    'composer.attachApp': 'Attach app',
    'composer.attachAppDesc': 'Connect via AT-SPI',
    'composer.attachAppTauriRequired': 'Requires Tauri',
    'composer.modePlan': 'Plan mode',
    'composer.modePlanDesc': 'Propose plan and wait for confirmation',
    'composer.pursueObjective': 'Pursue objective',
    'composer.pursueObjectiveDesc': 'Iterate until done (3 attempts)',
    'composer.addons': 'Add-ons',
    'composer.addonsDesc': 'Skills and MCP servers',
    'composer.voice': 'Voice',
    'composer.send': 'Send (Enter)',
    'composer.stop': 'Stop',
    'composer.changeModel': 'Change model',
    'composer.urlPrompt': 'URL of file to download:',
    'composer.attachedApp': 'Attached app',
    'composer.detachApp': 'Detach app',
    'composer.attachAppRequiresTauri': 'Attach app requires Tauri mode. Run with npm run tauri:dev.',
    'composer.nAttachments': '{n} attachment(s) · drag more or press + to add',
    'composer.disclaimer': 'Weaver can make mistakes. Verify critical actions.',
  },
};
