    ...
    #[cfg(target_os = "linux")]
    {
        builder = builder
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                db::projects_delete,
                db::projects_rename,
                db::projects_set_password,
                db::projects_verify_password,
                db::projects_set_scope,
                // Project members (colaboración local)
                db::members_list,
                db::members_create,
                db::members_update,
                db::members_delete,
                db::members_set_password,
                db::members_verify_password,
                // Conversations + messages
                db::conversations_list,
                db::conversations_create,
                db::conversations_set_project,
                db::conversations_set_owner,
                ...
                db::me_events_save,
                db::me_events_delete,
                db::me_calendars_list,
                db::me_calendars_save,
                db::me_calendars_delete,
                db::me_tasks_list,
                db::me_tasks_save,
                db::me_tasks_delete,
                db::me_notes_list,
